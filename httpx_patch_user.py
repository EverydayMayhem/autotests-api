...
response_patch_userid = httpx.patch(f'{base_url}/users/{user_id}', headers=headers, json=patch_body)
response_patch_userid_body = response_patch_userid.json()
print(f'Данные юзера {user_id}: {response_patch_userid_body}')
print(f'Статус код: {response_patch_userid.status_code}')