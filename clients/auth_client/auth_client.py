...
from clients.auth_client.auth_model import LoginRequestSchema, LoginResponseSchema, RefreshRequestSchema
...
class AuthClient(APIClient):
    ...
    def login(self, request: LoginRequestSchema) -> LoginResponseSchema:
        """
        обертка над login-api
        :param request: LoginRequestSchema
